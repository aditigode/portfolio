      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-[#F8F7F4]/95 backdrop-blur-sm shadow-sm" : "bg-[#F8F7F4]/80 backdrop-blur-sm"}`}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-6">
              ...
              <a href="/Resume.pdf" target="_blank" rel="noopener noreferrer" className="text-sm bg-[#C4A882] text-white px-4 py-2 rounded-full hover:bg-[#B09060] transition-colors font-medium">Resume</a>
            </div>
        ...
        {menuOpen && (
          <div className="md:hidden bg-[#F8F7F4] border-t border-stone-200 px-6 py-4 space-y-3">
            ...
            <a href="/Resume.pdf" target="_blank" rel="noopener noreferrer" className="block text-center bg-[#C4A882] text-white px-4 py-2 rounded-full hover:bg-[#B09060] transition-colors font-medium">Resume</a>
          </div>
        )}
      </nav>
            ...
            <div className="grid md:grid-cols-5 gap-10 items-center">
              ...
              <div className="md:col-span-3 space-y-4 text-slate-500 leading-relaxed">
                ...
                <div className="flex flex-wrap gap-3 pt-2">
                  ...
                  <a href="/Resume.pdf" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-[#8B6830] hover:underline">
